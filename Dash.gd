...
#	# Test data
	...
	brand = State.new(CONSTANTS.BRA, 	1000, get_node("Map/BrandenburgButton"))
	bremen = State.new(CONSTANTS.BRE, 	1000, get_node("Map/BremenButton"))
	hamb = State.new(CONSTANTS.HAM, 	1000, get_node("Map/HamburgButton"))
	hessen = State.new(CONSTANTS.HES, 	1000, get_node("Map/HessenButton"))
	meckPom = State.new(CONSTANTS.MVP, 	1000, get_node("Map/MeckPomButton"))
	nieders = State.new(CONSTANTS.NIE, 	1000, get_node("Map/NiedersachsenButton"))
	nrw = State.new(CONSTANTS.NRW, 		1000, get_node("Map/NrwButton"))
	rlp = State.new(CONSTANTS.RLP, 		1000, get_node("Map/RlpButton"))
	saar = State.new(CONSTANTS.SAA, 	1000, get_node("Map/SaarlandButton"))
	sachsen = State.new(CONSTANTS.SCN, 	1000, get_node("Map/SachsenButton"))
	sacanh = State.new(CONSTANTS.SCA, 	1000, get_node("Map/SachsenAnhaltButton"))
